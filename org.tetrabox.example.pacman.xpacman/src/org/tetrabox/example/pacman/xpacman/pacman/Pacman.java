 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.example.pacman.xpacman.pacman.Pacman#getInitialLives <em>Initial Lives</em>}</li>
 *   <li>{@link org.tetrabox.example.pacman.xpacman.pacman.Pacman#getPelletsEaten <em>Pellets Eaten</em>}</li>
 *   <li>{@link org.tetrabox.example.pacman.xpacman.pacman.Pacman#getLives <em>Lives</em>}</li>
 * </ul>
 *
 * @see org.tetrabox.example.pacman.xpacman.pacman.PacmanPackage#getPacman()
 * @model
 * @generated
 */
public interface Pacman extends Entity {
	 ...
	 * @see org.tetrabox.example.pacman.xpacman.pacman.PacmanPackage#getPacman_InitialLives()
	 * @model
	 * @generated
	 */
	int getInitialLives();
	...
	/**
	 * Sets the value of the '{@link org.tetrabox.example.pacman.xpacman.pacman.Pacman#getInitialLives <em>Initial Lives</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.tetrabox.example.pacman.xpacman.pacman.PacmanPackage#getPacman_PelletsEaten()
	 * @model unique="false"
	 * @generated
	 */
	int getPelletsEaten();
	...
	/**
	 * Sets the value of the '{@link org.tetrabox.example.pacman.xpacman.pacman.Pacman#getPelletsEaten <em>Pellets Eaten</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setLives(int)
	 * @see org.tetrabox.example.pacman.xpacman.pacman.PacmanPackage#getPacman_Lives()
	 * @model unique="false"
	 * @generated
	 */
	int getLives();
	...
	/**
	 * Sets the value of the '{@link org.tetrabox.example.pacman.xpacman.pacman.Pacman#getLives <em>Lives</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
