...
public class PassableTileAdapter extends EObjectAdapter<PassableTile> implements org.tetrabox.example.pacman.xpacmanmt.pacman.PassableTile {
  private XPacmanMTAdaptersFactory adaptersFactory;
  
  public PassableTileAdapter() {
  ...
  public EClass eClass() {
    return org.tetrabox.example.pacman.xpacmanmt.pacman.PacmanPackage.eINSTANCE.getPassableTile();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.example.pacman.xpacmanmt.pacman.PacmanPackage.PASSABLE_TILE__TOP:
    		return getTop();
    	case org.tetrabox.example.pacman.xpacmanmt.pacman.PacmanPackage.PASSABLE_TILE__RIGHT:
    		return getRight();
    	case org.tetrabox.example.pacman.xpacmanmt.pacman.PacmanPackage.PASSABLE_TILE__BOTTOM:
    		return getBottom();
    	case org.tetrabox.example.pacman.xpacmanmt.pacman.PacmanPackage.PASSABLE_TILE__LEFT:
    		return getLeft();
    	case org.tetrabox.example.pacman.xpacmanmt.pacman.PacmanPackage.PASSABLE_TILE__X:
    		return new java.lang.Integer(getX());
    	case org.tetrabox.example.pacman.xpacmanmt.pacman.PacmanPackage.PASSABLE_TILE__Y:
