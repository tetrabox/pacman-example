 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.example.pacman.xpacman.event.pacmanevent.impl.PacmanEventImpl#getPacman <em>Pacman</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PacmanEventImpl extends PacmanDSLEventImpl implements PacmanEvent {
	/**
	...
	protected EClass eStaticClass() {
		return PacmaneventPackage.Literals.PACMAN_EVENT;
	}
		...
		if (pacman != null && pacman.eIsProxy()) {
			...
			if (pacman != oldPacman) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PacmaneventPackage.PACMAN_EVENT__PACMAN, oldPacman, pacman));
			}
		}
		return pacman;
	}
	...
	public void setPacman(Pacman newPacman) {
		...
		pacman = newPacman;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PacmaneventPackage.PACMAN_EVENT__PACMAN, oldPacman, pacman));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PacmaneventPackage.PACMAN_EVENT__PACMAN:
